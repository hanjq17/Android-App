...
public class ChannelActivity extends GestureDetectorActivity implements AdapterView.OnItemClickListener {
    ...
    private void initData() {
        userChannelList = newsDatabaseManager.selectItemByStatus(1);
        otherChannelList=newsDatabaseManager.selectItemByStatus(0);
    ...
    private void saveChannel() {
        ...
        newsDatabaseManager.addGridItems(userAdapter.getChannnelLst(),1);
        newsDatabaseManager.addGridItems(otherAdapter.getChannnelLst(),0);
    }
